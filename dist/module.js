...
class $355a0ba890fd58e7$var$LoggerObject {
    ...
    get reset() {
        ...
        this.styleString += ";";
        $355a0ba890fd58e7$var$realConsole.log("this.styleString", this.styleString);
    ...
    log(...others) {
        $355a0ba890fd58e7$var$realConsole.debug(`this.styleString is:`, this.styleString);
        $355a0ba890fd58e7$var$realConsole.debug(`this.stringBuffer is:`, this.stringBuffer);
        $355a0ba890fd58e7$var$realConsole.debug(`this.attributeBuffer is:`, this.attributeBuffer);
