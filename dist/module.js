...
function $c06b5817ebab9838$export$2e2bcd8739ae039(flag, argv = Deno.args) {
...
const $0080e263a13fea1b$var$env = Deno.env.toObject();
...
class $355a0ba890fd58e7$var$LoggerObject {
    ...
    log(...others) {
        $355a0ba890fd58e7$export$e896d9a1b4631fa1.log(this.toString().replace("%", "%%"), ...others);
        return this;
    }
}
const $355a0ba890fd58e7$export$9d69f5c452819e4 = {
    reset (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().reset(...args);
    },
    bold (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bold(...args);
    },
    dim (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().dim(...args);
    },
    italic (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().italic(...args);
    },
    underline (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().underline(...args);
    },
    inverse (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().inverse(...args);
    },
    hidden (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().hidden(...args);
    },
    strikethrough (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().strikethrough(...args);
    },
    visible (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().visible(...args);
    },
    black (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().black(...args);
    },
    red (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().red(...args);
    },
    green (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().green(...args);
    },
    yellow (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().yellow(...args);
    },
    blue (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blue(...args);
    },
    magenta (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().magenta(...args);
    },
    cyan (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().cyan(...args);
    },
    white (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().white(...args);
    },
    blackBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blackBright(...args);
    },
    gray (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().gray(...args);
    },
    grey (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().grey(...args);
    },
    redBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().redBright(...args);
    },
    greenBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().greenBright(...args);
    },
    yellowBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().yellowBright(...args);
    },
    blueBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blueBright(...args);
    },
    magentaBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().magentaBright(...args);
    },
    cyanBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().cyanBright(...args);
    },
    whiteBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().whiteBright(...args);
    },
    bgBlack (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlack(...args);
    },
    bgRed (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgRed(...args);
    },
    bgGreen (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGreen(...args);
    },
    bgYellow (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgYellow(...args);
    },
    bgBlue (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlue(...args);
    },
    bgMagenta (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgMagenta(...args);
    },
    bgCyan (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgCyan(...args);
    },
    bgWhite (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgWhite(...args);
    },
    bgBlackBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlackBright(...args);
    },
    bgGray (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGray(...args);
    },
    bgGrey (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGrey(...args);
    },
    bgRedBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgRedBright(...args);
    },
    bgGreenBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGreenBright(...args);
    },
    bgYellowBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgYellowBright(...args);
    },
    bgBlueBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlueBright(...args);
    },
    bgMagentaBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgMagentaBright(...args);
    },
    bgCyanBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgCyanBright(...args);
    },
    bgWhiteBright (...args) {
...
const $355a0ba890fd58e7$export$e896d9a1b4631fa1 = {
    ...
    bold (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bold(...args).log();
    },
    dim (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().dim(...args).log();
    },
    italic (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().italic(...args).log();
    },
    underline (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().underline(...args).log();
    },
    inverse (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().inverse(...args).log();
    },
    hidden (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().hidden(...args).log();
    },
    strikethrough (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().strikethrough(...args).log();
    },
    visible (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().visible(...args).log();
    },
    black (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().black(...args).log();
    },
    red (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().red(...args).log();
    },
    green (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().green(...args).log();
    },
    yellow (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().yellow(...args).log();
    },
    blue (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blue(...args).log();
    },
    magenta (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().magenta(...args).log();
    },
    cyan (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().cyan(...args).log();
    },
    white (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().white(...args).log();
    },
    blackBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blackBright(...args).log();
    },
    gray (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().gray(...args).log();
    },
    grey (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().grey(...args).log();
    },
    redBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().redBright(...args).log();
    },
    greenBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().greenBright(...args).log();
    },
    yellowBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().yellowBright(...args).log();
    },
    blueBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().blueBright(...args).log();
    },
    magentaBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().magentaBright(...args).log();
    },
    cyanBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().cyanBright(...args).log();
    },
    whiteBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().whiteBright(...args).log();
    },
    bgBlack (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlack(...args).log();
    },
    bgRed (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgRed(...args).log();
    },
    bgGreen (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGreen(...args).log();
    },
    bgYellow (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgYellow(...args).log();
    },
    bgBlue (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlue(...args).log();
    },
    bgMagenta (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgMagenta(...args).log();
    },
    bgCyan (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgCyan(...args).log();
    },
    bgWhite (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgWhite(...args).log();
    },
    bgBlackBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlackBright(...args).log();
    },
    bgGray (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGray(...args).log();
    },
    bgGrey (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGrey(...args).log();
    },
    bgRedBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgRedBright(...args).log();
    },
    bgGreenBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgGreenBright(...args).log();
    },
    bgYellowBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgYellowBright(...args).log();
    },
    bgBlueBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgBlueBright(...args).log();
    },
    bgMagentaBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgMagentaBright(...args).log();
    },
    bgCyanBright (...args) {
        return new $355a0ba890fd58e7$var$LoggerObject().bgCyanBright(...args).log();
    },
    bgWhiteBright (...args) {
