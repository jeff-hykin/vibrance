...
Object.assign(vibrance, {
    get reset           () { console.log(Math.random()); return (new LoggerObject()).reset },
    get bold            () { console.log(Math.random()); return (new LoggerObject()).bold },
    get dim             () { console.log(Math.random()); return (new LoggerObject()).dim },
    get italic          () { console.log(Math.random()); return (new LoggerObject()).italic },
    get underline       () { console.log(Math.random()); return (new LoggerObject()).underline },
    get inverse         () { console.log(Math.random()); return (new LoggerObject()).inverse },
    get hidden          () { console.log(Math.random()); return (new LoggerObject()).hidden },
    get strikethrough   () { console.log(Math.random()); return (new LoggerObject()).strikethrough },
    get visible         () { console.log(Math.random()); return (new LoggerObject()).visible },
    get black           () { console.log(Math.random()); return (new LoggerObject()).black },
    get red             () { console.log(Math.random()); return (new LoggerObject()).red },
    get green           () { console.log(Math.random()); return (new LoggerObject()).green },
    get yellow          () { console.log(Math.random()); return (new LoggerObject()).yellow },
    get blue            () { console.log(Math.random()); return (new LoggerObject()).blue },
    get magenta         () { console.log(Math.random()); return (new LoggerObject()).magenta },
    get cyan            () { console.log(Math.random()); return (new LoggerObject()).cyan },
    get white           () { console.log(Math.random()); return (new LoggerObject()).white },
    get blackBright     () { console.log(Math.random()); return (new LoggerObject()).blackBright },
    get gray            () { console.log(Math.random()); return (new LoggerObject()).gray },
    get grey            () { console.log(Math.random()); return (new LoggerObject()).grey },
    get redBright       () { console.log(Math.random()); return (new LoggerObject()).redBright },
    get greenBright     () { console.log(Math.random()); return (new LoggerObject()).greenBright },
    get yellowBright    () { console.log(Math.random()); return (new LoggerObject()).yellowBright },
    get blueBright      () { console.log(Math.random()); return (new LoggerObject()).blueBright },
    get magentaBright   () { console.log(Math.random()); return (new LoggerObject()).magentaBright },
    get cyanBright      () { console.log(Math.random()); return (new LoggerObject()).cyanBright },
    get whiteBright     () { console.log(Math.random()); return (new LoggerObject()).whiteBright },
    get bgBlack         () { console.log(Math.random()); return (new LoggerObject()).bgBlack },
    get bgRed           () { console.log(Math.random()); return (new LoggerObject()).bgRed },
    get bgGreen         () { console.log(Math.random()); return (new LoggerObject()).bgGreen },
    get bgYellow        () { console.log(Math.random()); return (new LoggerObject()).bgYellow },
    get bgBlue          () { console.log(Math.random()); return (new LoggerObject()).bgBlue },
    get bgMagenta       () { console.log(Math.random()); return (new LoggerObject()).bgMagenta },
    get bgCyan          () { console.log(Math.random()); return (new LoggerObject()).bgCyan },
    get bgWhite         () { console.log(Math.random()); return (new LoggerObject()).bgWhite },
    get bgBlackBright   () { console.log(Math.random()); return (new LoggerObject()).bgBlackBright },
    get bgGray          () { console.log(Math.random()); return (new LoggerObject()).bgGray },
    get bgGrey          () { console.log(Math.random()); return (new LoggerObject()).bgGrey },
    get bgRedBright     () { console.log(Math.random()); return (new LoggerObject()).bgRedBright },
    get bgGreenBright   () { console.log(Math.random()); return (new LoggerObject()).bgGreenBright },
    get bgYellowBright  () { console.log(Math.random()); return (new LoggerObject()).bgYellowBright },
    get bgBlueBright    () { console.log(Math.random()); return (new LoggerObject()).bgBlueBright },
    get bgMagentaBright () { console.log(Math.random()); return (new LoggerObject()).bgMagentaBright },
    get bgCyanBright    () { console.log(Math.random()); return (new LoggerObject()).bgCyanBright },
    get bgWhiteBright   () { console.log(Math.random()); return (new LoggerObject()).bgWhiteBright },
})
