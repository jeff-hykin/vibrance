module.exports = (chalk)=>{
    ...
    let console = {
        ...
        get lightBlack      () { return (new ConsoleObject()).blackBright },
        get lightRed        () { return (new ConsoleObject()).redBright },
        get lightGreen      () { return (new ConsoleObject()).greenBright },
        get lightYellow     () { return (new ConsoleObject()).yellowBright },
        get lightBlue       () { return (new ConsoleObject()).blueBright },
        get lightMagenta    () { return (new ConsoleObject()).magentaBright },
        get lightCyan       () { return (new ConsoleObject()).cyanBright },
        get lightWhite      () { return (new ConsoleObject()).whiteBright },
        ...
        get blackBackground        () { return (new ConsoleObject()).bgBlack },
        get redBackground          () { return (new ConsoleObject()).bgRed },
        get greenBackground        () { return (new ConsoleObject()).bgGreen },
        get yellowBackground       () { return (new ConsoleObject()).bgYellow },
        get blueBackground         () { return (new ConsoleObject()).bgBlue },
        get magentaBackground      () { return (new ConsoleObject()).bgMagenta },
        get cyanBackground         () { return (new ConsoleObject()).bgCyan },
        get whiteBackground        () { return (new ConsoleObject()).bgWhite },
        get grayBackground         () { return (new ConsoleObject()).bgGray },
        get greyBackground         () { return (new ConsoleObject()).bgGrey },
        get lightBlackBackground   () { return (new ConsoleObject()).bgBlackBright },
        get lightRedBackground     () { return (new ConsoleObject()).bgRedBright },
        get lightGreenBackground   () { return (new ConsoleObject()).bgGreenBright },
        get lightYellowBackground  () { return (new ConsoleObject()).bgYellowBright },
        get lightBlueBackground    () { return (new ConsoleObject()).bgBlueBright },
        get lightMagentaBackground () { return (new ConsoleObject()).bgMagentaBright },
        get lightCyanBackground    () { return (new ConsoleObject()).bgCyanBright },
        get lightWhiteBackground   () { return (new ConsoleObject()).bgWhiteBright },
