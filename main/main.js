module.exports = (chalk)=>{
    ...
    let console = {
        ...
        get lightBlack      () { return (new LoggerObject()).blackBright },
        get lightRed        () { return (new LoggerObject()).redBright },
        get lightGreen      () { return (new LoggerObject()).greenBright },
        get lightYellow     () { return (new LoggerObject()).yellowBright },
        get lightBlue       () { return (new LoggerObject()).blueBright },
        get lightMagenta    () { return (new LoggerObject()).magentaBright },
        get lightCyan       () { return (new LoggerObject()).cyanBright },
        get lightWhite      () { return (new LoggerObject()).whiteBright },
        ...
        get blackBackground        () { return (new LoggerObject()).bgBlack },
        get redBackground          () { return (new LoggerObject()).bgRed },
        get greenBackground        () { return (new LoggerObject()).bgGreen },
        get yellowBackground       () { return (new LoggerObject()).bgYellow },
        get blueBackground         () { return (new LoggerObject()).bgBlue },
        get magentaBackground      () { return (new LoggerObject()).bgMagenta },
        get cyanBackground         () { return (new LoggerObject()).bgCyan },
        get whiteBackground        () { return (new LoggerObject()).bgWhite },
        get grayBackground         () { return (new LoggerObject()).bgGray },
        get greyBackground         () { return (new LoggerObject()).bgGrey },
        get lightBlackBackground   () { return (new LoggerObject()).bgBlackBright },
        get lightRedBackground     () { return (new LoggerObject()).bgRedBright },
        get lightGreenBackground   () { return (new LoggerObject()).bgGreenBright },
        get lightYellowBackground  () { return (new LoggerObject()).bgYellowBright },
        get lightBlueBackground    () { return (new LoggerObject()).bgBlueBright },
        get lightMagentaBackground () { return (new LoggerObject()).bgMagentaBright },
        get lightCyanBackground    () { return (new LoggerObject()).bgCyanBright },
        get lightWhiteBackground   () { return (new LoggerObject()).bgWhiteBright },
